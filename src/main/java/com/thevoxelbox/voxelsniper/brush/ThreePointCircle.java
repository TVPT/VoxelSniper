...
public class ThreePointCircle extends PerformBrush {
    ...
    @Override
    public void arrow(com.thevoxelbox.voxelsniper.vData v) {//Add a point

        TPCArrow(v);
    }

    @Override
    public void powder(com.thevoxelbox.voxelsniper.vData v) {  //Make the circle
    ...
    public void parameters(String[] par, com.thevoxelbox.voxelsniper.vData v) {
        if (par[1].equalsIgnoreCase("info")) {
            v.sendMessage(ChatColor.GOLD + "3-Point Circle Brush instructions: Select three corners with the arrow brush, then generate the Circle with the powder brush.");
            return;
        }
    ...
    public void TPCArrow(com.thevoxelbox.voxelsniper.vData v) {
        switch (cornernumber) {
            case 1:
    ...
    public void TPCPowder(com.thevoxelbox.voxelsniper.vData v) {
        w = v.getWorld();
        ...
        if (sidelengthone == 0 || sidelengthtwo == 0 || sidelengththree == 0 || coordsone[0] * (coordstwo[1] - coordsthree[1]) + coordstwo[0] * (coordsthree[1] - coordsone[1]) + coordsthree[0] * (coordsone[1] - coordstwo[1]) == 0) {
            ...
            radius = Math.pow(Math.pow((coordsone[0] - circumcenter[0]), 2) + Math.pow((coordsone[1] - circumcenter[1]), 2) + Math.pow((coordsone[2] - circumcenter[2]), 2), .5);
            ...
            for (int x = -bsize; x <= bsize; x++) {
                for (int y = -bsize; y <= bsize; y++) {
                    for (int z = -bsize; z <= bsize; z++) {
                        ...
                        double tempconstant = normalvector[0] * (circumcenter[0]+x+.5) + normalvector[1] * (circumcenter[1]+y+.5) + normalvector[2] * (circumcenter[2]+z+.5);
