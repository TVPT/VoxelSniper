    ...
    public final void parameters(final String[] par, final SnipeData v) {
        ...
        for (int i = 1; i < par.length; i++) {
            ...
            if (parameter.equalsIgnoreCase("info")) {
                v.sendMessage(TextColors.GOLD, "Splatter Voxel Disc brush Parameters:");
                v.sendMessage(TextColors.AQUA, "/b svd s[int] -- set a seed percentage (1-9999). 100 = 1% Default is 1000");
                v.sendMessage(TextColors.AQUA, "/b svd g[int] -- set a growth percentage (1-9999).  Default is 1000");
