...
public class BlendVoxelDiscBrush extends BlendBrushBase
{
    ...
    protected final void blend(final SnipeData v)
    {
        ...
        for (int _x = _twoBrushSize; _x >= 0; _x--)
        {
            ...
            {
                if (!(this.excludeAir && _newMaterials[_x][_z] == Material.AIR.getId()) && !(this.excludeWater && (_newMaterials[_x][_z] == Material.WATER.getId() || _newMaterials[_x][_z] == Material.STATIONARY_WATER.getId())))
                {
