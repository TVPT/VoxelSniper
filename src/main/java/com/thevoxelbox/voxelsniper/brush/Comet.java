 ...
 * 
 * @author Gavjenks Heavily revamped from ruler brush by Giltwist
 */
public class Comet extends Brush {
    ...
    public void dofireball(vData v) {
        ...
        // Hadoken!
        EntitySmallFireball entityfireball = new EntitySmallFireball(((CraftWorld) v.owner().getPlayer().getWorld()).getHandle(), ((CraftPlayer) v.owner()
                .getPlayer()).getHandle(), slopevector[0] * linelength, slopevector[1] * linelength, slopevector[2] * linelength);
        CraftSmallFireball craftfireball = new CraftSmallFireball((CraftServer) v.owner().getPlayer().getServer(), entityfireball);
