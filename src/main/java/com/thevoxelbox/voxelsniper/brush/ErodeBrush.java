...
//        v.owner().storeUndo(undo);
    ...
    private void fillIteration(final SnipeData v, final ErosionPreset erosionPreset, final BlockChangeTracker blockChangeTracker,
            final Vector3i targetBlockVector) {
...
//        }
    ...
    private void erosionIteration(final SnipeData v, final ErosionPreset erosionPreset, final BlockChangeTracker blockChangeTracker,
            final Vector3i targetBlockVector) {
//        final int currentIteration = blockChangeTracker.nextIteration();
//        for (int x = this.getTargetBlock().getX() - v.getBrushSize(); x <= this.getTargetBlock().getX() + v.getBrushSize(); ++x)
//        {
...
//                    result.getInt("fill"), this.currentPreset.getFillRecursion());
//        }
//
//        if (result.getObject("erode") != null) {
//            this.currentPreset = new ErosionPreset(result.getInt("erode"), this.currentPreset.getErosionRecursion(),
//                    this.currentPreset.getFillFaces(), this.currentPreset.getFillRecursion());
//        }
//
//        if (result.getObject("fillrecursion") != null) {
//            this.currentPreset = new ErosionPreset(this.currentPreset.getErosionFaces(), this.currentPreset.getErosionRecursion(),
//                    this.currentPreset.getFillFaces(), result.getInt("fillrecursion"));
//        }
//
//        if (result.getObject("eroderecursion") != null) {
//            this.currentPreset = new ErosionPreset(this.currentPreset.getErosionFaces(), result.getInt("eroderecursion"),
//                    this.currentPreset.getFillFaces(), this.currentPreset.getFillRecursion());
//        }
//
