            ...
            case RIGHT_CLICK_BLOCK:
                switch (heldItem)
                {
                    case ARROW:
                        ...
                        { // Changed due to an excellent member suggestion: when crouch clicking the sky or void, it should just set material or replace material
            ...
            case LEFT_CLICK_BLOCK:
                switch (heldItem)
                {
                    case ARROW:
                        ...
                        { // See above comment for right click -Gavjenks
                            v.owner().setVoxel(0);
                            return true;
                        }
