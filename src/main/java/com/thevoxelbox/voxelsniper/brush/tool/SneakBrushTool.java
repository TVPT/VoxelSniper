...
public class SneakBrushTool extends BrushTool
{
    ...
    {
        return playr.isSneaking() ? sneak.perform(action, data, Material.ARROW, clickedBlock, clickedFace) : brush.perform(action, data, arrowMode ? Material.ARROW : Material.SULPHUR, clickedBlock, clickedFace);
    }
}
